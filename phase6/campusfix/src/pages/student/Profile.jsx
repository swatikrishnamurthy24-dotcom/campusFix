...
export default function Profile() {
  ...
  function handleSave() {
    ...
    // Mock-only: this updates AuthContext + localStorage. There is no real
    // backend profile endpoint yet — see Phase 4 §11 / AuthContext.updateUser.
    ...
    <div className="mx-auto max-w-lg space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your CampusFix account details.</CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-sm text-muted-foreground">
                {user.studentId ?? "Not linked yet — this will sync once accounts are provisioned by admin."}
              </p>
            </div>
          </div>
        </CardContent>
