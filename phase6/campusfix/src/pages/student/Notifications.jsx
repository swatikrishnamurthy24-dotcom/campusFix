...
import { Bell, CheckCheck, MessageSquare, ArrowBigUp, RefreshCcw, BellOff } from "lucide-react"
        ...
        <ul className="space-y-2">
          {notifications.map((n) => {
            ...
            return (
              <li key={n.id}>
                {n.issueId ? (
                  <Link to={`/student/issues/${n.issueId}`} onClick={() => !n.read && handleMarkRead(n.id)}>
                    {content}
                  </Link>
                ) : (
